...
class ViewController: UIViewController,UITableViewDelegate, UITableViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        //导航栏控制器右边的按钮
        right = UIBarButtonItem(title: "编辑", style: .plain, target: self, action: #selector(edit))
    ...
    @objc func addStudent() {
        ...
        alert = UIAlertController(title: "添加", message: "学生", preferredStyle: .alert)
   ...
   func tableView(_ tableView: UITableView,
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let name: String
        let cate = tableTitle[indexPath.section]
        ...
        let message = "you selected \(cate), name: \(name)"
